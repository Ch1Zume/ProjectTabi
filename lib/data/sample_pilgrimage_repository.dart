...
class SamplePilgrimageRepository implements PilgrimageRepository, SyncRepository {
  ...
  Future<void> replaceSyncSnapshot(SamplePilgrimageRepositorySnapshot state) async {
    ...
    _plans..clear()..addAll(state.plans);
    _visitRecords..clear()..addAll(state.visitRecords);
    _activePlanId = state.activePlanId;
  ...
  Future<void> saveAppSettings(AppSettings settings) async {
    _settings = settings.copyWith(
      ...
      comparisonExportConfigJson: settings.comparisonExportConfigJson.trim(),
      ...
      anitabiSiteBaseUrl: settings.anitabiSiteBaseUrl.trim(),
      anitabiStaticDataBaseUrl: settings.anitabiStaticDataBaseUrl.trim(),
