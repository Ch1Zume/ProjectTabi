...
Future<Map<String, Object?>> invokeWebDavCommand(String command, Map<String, Object?> request) async {
  final object = await _invokeObject(command, {'request': request});
  if (object == null) throw StateError('Desktop WebDAV bridge unavailable');
  return Map<String, Object?>.from(jsonDecode(_jsonStringify(object).toDart) as Map);
}
@JS('JSON.stringify')
