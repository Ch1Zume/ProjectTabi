...
Map<String, Object?> _settingsJson(AppSettings settings) {
  return {
    ...
    'mapAppearance': settings.mapAppearance.name,
...
AppSettings _settingsFromJson(Map<String, Object?> json) {
  return AppSettings(
    ...
    mapMarkerClusterMaxZoom: _intValue(json['mapMarkerClusterMaxZoom']) ?? 21,
    ...
    mapAppearance:
        _enumByName(MapAppearance.values, json['mapAppearance']) ??
