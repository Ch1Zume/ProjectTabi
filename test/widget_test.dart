...
import 'package:project_tabi/data/anitabi_client.dart';
...
import 'package:project_tabi/map/map_marker_clustering.dart';
...
import 'package:project_tabi/plan/add_points_screen.dart';
import 'package:project_tabi/plan/anitabi_map_import_screen.dart';
import 'package:project_tabi/plan/nearest_group_assign_screen.dart';
import 'package:project_tabi/plan/plan_group_manager_screen.dart';
import 'package:project_tabi/plan/plan_manager_screen.dart';
import 'package:project_tabi/plan/point_manager_screen.dart';
import 'package:project_tabi/plan/work_manager_screen.dart';
...
import 'package:project_tabi/records/comparison_export_config.dart';
import 'package:project_tabi/widgets/constrained_menu_anchor.dart';
import 'package:project_tabi/widgets/confirm_action_dialog.dart';
import 'package:project_tabi/widgets/input_dialog.dart';
import 'package:project_tabi/widgets/reference_image_placeholder.dart';
import 'package:project_tabi/widgets/responsive_button.dart';
...
Future<void> _pumpAppWithEmptyPlan(WidgetTester tester) async {
  ...
  await tester.pumpWidget(ProjectTabiApp(repository: repository));
  await tester.pumpAndSettle();
}
...
void main() {
  ...
  testWidgets('completed plan group uses a checked filled folder', (
    ...
    await tester.pumpWidget(
      ProjectTabiApp(repository: SamplePilgrimageRepository(plans: [plan])),
    );
    await tester.pumpAndSettle();
  ...
  testWidgets('quick manual point paste fills coordinates without a dialog', (
    ...
    await tester.pumpWidget(
      ProjectTabiApp(repository: SamplePilgrimageRepository()),
    );
    await tester.pumpAndSettle();
