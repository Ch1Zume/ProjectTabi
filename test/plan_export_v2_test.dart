...
import 'package:project_tabi/plan_transfer/plan_export_v2.dart';
import 'package:project_tabi/plan_transfer/plan_export_size_estimator.dart';
...
void main() {
  ...
  test('exports bundled reference assets and record photos', () async {
    ...
    expect(manifest['appVersion'], projectTabiAppVersion);
